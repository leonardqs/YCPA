...
epi{1} = ones(nx{1},ny{1})*c_eps_0; % Adds the inclusions
epi{1}(75:150,30:120)= c_eps_0*21.3;
...
% s(1) adds one source to the boundary 
bc{1}.NumS = 1;
...
bc{1}.xm.type = 'a';
bc{1}.xp.type = 'e'; % Change to e, the xp side no longer can absorb E field, instead it will reflect them back
bc{1}.ym.type = 'a';
bc{1}.yp.type = 'a';
